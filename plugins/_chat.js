let handler = m => m; 
 ...
   let responses; 
   if (/^كانيكي بحبك|كانيكي عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|كانيكي هنتجوز امتي|كانيكي انت ليا|كانيكي بموت فيك$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^ كانيكي عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
     responses = [ 
 ...
                             'دوم ' 
   ]; 
   }else if (/^كانيكي|كانيكي عمك|يا كانيكي$/i.test(m.text)) { 
     responses = [ 
       'قلب كانيكي من جوا✨🥺♥',  
          ' كانيكي عمك✨🤺 ',  
              ' قلب كانيكي من جوا✨🥺♥',  
